...
def g2(x):
    ...
    x2 = (x - 1) ** 2
    return np.where(x2 == 0.0, g2_1, 
        np.log(x2) * (x - 1) * (-25 + x*(23 + x*(-13 + 3*x))) / 24 + \
        (3.758456287028533e-7 + x*(3.083272601141418 + x*(-0.3737975183428218 + (0.660849876845528 + 0.7434313817195289*x)*x))) / \
